    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-8 sm:pt-24 lg:px-8 lg:pt-16">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
                <p class="text-xs leading-6 text-gray-600">This project is made possible by the collection, standardization and publication of CRS reports by EveryCRSReport.com, a project of Demand Progress in collaboration with the Congressional Data Coalition — a bipartisan coalition founded by Demand Progress and the R Street Institute to promote open legislative information. EveryCRSReport has been a labor of love and tireless advocacy led by Daniel Schuman for many years, building on the efforts of many others, as described here. It is a successful example of civil society prototyping new approaches, leading to better institutional practices, and making new projects possible (like this one). We are grateful to Demand Progress, the Congressional Data Coalition, R Street, and Daniel Schuman for their leadership.</p>
